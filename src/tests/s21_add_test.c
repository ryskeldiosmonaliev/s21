...
START_TEST(add_test_15) {
  s21_decimal src1, src2;
  float num1 = -940.3f;
  float num2 = 0.000234f;
  float res_origin = -940.299766f;
  s21_from_float_to_decimal(num1, &src1);
  s21_from_float_to_decimal(num2, &src2);
  s21_decimal res_dec = {0};
  float res_float = 0.0f;
...
START_TEST(add_test_18) {
  s21_decimal src1, src2;
  float num1 = -0.9403f;
  float num2 = -112.0234f;
  float res_origin = -112.9637f;
  s21_from_float_to_decimal(num1, &src1);
  s21_from_float_to_decimal(num2, &src2);
  s21_decimal res_dec = {0};
  float res_float = 0.0f;
...
START_TEST(add_test_24) {
  s21_decimal dec1, dec2;
  dec1.bits[3] = POSITIVE;
  dec1.bits[2] = -1;
  dec1.bits[1] = 0;
  dec1.bits[0] = 0;
  dec2.bits[3] = POSITIVE;
  dec2.bits[2] = 0;
  dec2.bits[1] = -1;
  dec2.bits[0] = -1;
  s21_decimal res;
...
START_TEST(add_test_27) {
  s21_decimal dec1 = {{-1, -1, -1, NEGATIVE}};
  s21_decimal dec2 = {{-1, -1, -1, NEGATIVE}};
  int ret_s21 = s21_add(dec1, dec2, &dec1);
  ck_assert_int_eq(2, ret_s21);
}
END_TEST

START_TEST(add_test_28) {
  float float_a = -10758.750f;
  float float_b = 6268.750f;
...
Suite *suite_add() {
  Suite *s21_suite = suite_create("add_tests");
